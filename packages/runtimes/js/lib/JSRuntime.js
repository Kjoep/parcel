  ...
  apply({bundle, bundleGraph, options}) {
    ...
    for (let dependency of asyncDependencies) {
      ...
      if (resolved.type === 'asset') {
        ...
        if (
          (referencedBundle === null || referencedBundle === void 0
            ? void 0
    ...
    for (let dependency of otherDependencies) {
      ...
      let mainBundle = (0, _nullthrows().default)(
      ...
      if (
        ...
        ((_dependency$meta = dependency.meta) === null ||
        _dependency$meta === void 0
          ? void 0
          : _dependency$meta.placeholder) != null
      ) {
        continue;
...
function getLoaderRuntime({
  ...
  let mainBundle = (0, _nullthrows().default)(
    externalBundles.find(bundle => {
      ...
      return (
        ((_bundle$getMainEntry = bundle.getMainEntry()) === null ||
        _bundle$getMainEntry === void 0
          ? void 0
          : _bundle$getMainEntry.id) === bundleGroup.entryAssetId
      );
    }),
  ...
  if (bundle.env.context === 'browser' && !options.shouldBuildLazily) {
    loaderModules.push(
      ...externalBundles // TODO: Allow css to preload resources as well
...
function getHintedBundleGroups(bundleGraph, bundle) {
  ...
  for (let dependency of asyncDependencies) {
    ...
    let attributes =
      (_dependency$meta2 = dependency.meta) === null ||
      _dependency$meta2 === void 0
        ? void 0
        : _dependency$meta2.importAttributes;

    if (
      typeof attributes === 'object' &&
      attributes != null && // $FlowFixMe
...
function getRegisterCode(entryBundle, bundleGraph) {
  ...
  bundleGraph.traverseBundles((bundle, _, actions) => {
    ...
    idToName[bundle.publicId] = _path().default.basename(
      (0, _nullthrows().default)(bundle.name),
    );
